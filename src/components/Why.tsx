...
function EndToEndCard() {
  ...
  const steps = [
    ...
    { label: 'Launch', desc: 'Go-to-market', icon: <Rocket className="w-5 h-5"/> }
  ];
                 ...
                 return (
                     <div key={idx} className="relative flex flex-col items-center w-1/4">
                         <div className="relative">
                             ...
                             {/* Active/Highlighted */}
                             <motion.div 
                                 className={`absolute inset-0 rounded-[16px] flex items-center justify-center z-20 ${isLast ? 'bg-[var(--accent)] text-white border border-transparent shadow-[0_0_20px_rgba(37,99,235,0.4)]' : 'bg-[var(--dark)] text-white border border-[var(--dark)] shadow-md'}`}
