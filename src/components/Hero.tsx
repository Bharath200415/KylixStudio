          ...
          <div className="w-1/2 flex flex-col gap-2 animate-[scrollY_20s_linear_infinite] mt-[-150px]">
            {[...Array(2)].map((_, i) => (
              <div key={`right-${i}`} className="flex flex-col gap-2">
                {/* Menu/SCROLL */}
                <div className="w-full h-[170px] md:h-[220px] bg-gradient-to-br from-[#2a1a10] to-black rounded-[25px] overflow-hidden relative group p-6">
                ...
                {/* Forget the system */}
                <div className="w-full h-[170px] md:h-[320px] bg-gradient-to-b from-[#111] to-[#000] rounded-[25px] overflow-hidden relative group">
