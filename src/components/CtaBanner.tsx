  ...
  return (
    <section id="contact" className="bg-[#0D0D0D] py-12 md:py-[80px] text-center relative overflow-hidden scroll-reveal">
      <div className="max-w-full w-full mx-auto px-6">
        ...
        <h2 className="font-display italic text-[48px] md:text-[68px] leading-[1.05] text-white my-4 md:my-5"><span className="not-italic font-semibold font-sans">Ready to build</span><br/><em>something great?</em></h2>
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          <a href="#contact" className="inline-flex items-center justify-center bg-[#C8FF00] text-[#0D0D0D] font-sans font-semibold text-[15px] px-8 py-3.5 rounded-full no-underline transition-all duration-200 border border-[#C8FF00] hover:opacity-90 hover:-translate-y-[1px]">Book a Free Call</a>
